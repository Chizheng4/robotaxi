...
test -f scripts/build-github-pages.mjs || fail "缺少 EdgeOne 生产构建脚本"
test ! -f .github/workflows/deploy-pages.yml || fail "GitHub Pages 自动部署工作流必须停用"
...
node --check scripts/verify-v049-13-23-kv-runtime-binding.mjs
...
node scripts/verify-v049-13-22-publish-source-preflight.mjs
node scripts/verify-v049-13-23-kv-runtime-binding.mjs
...
node --check scripts/verify-v049-4-city-spatial-editing.mjs
...
node scripts/verify-v049-3-city-spatial-foundation.mjs
node scripts/verify-v049-4-city-spatial-editing.mjs
