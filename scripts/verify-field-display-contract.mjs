...
import { getDisplayValue, validateFieldDisplayContract } from "../src/domain/fieldDisplayService.js";
...
[
  ...
  "longTermDemandForecast", "supplyPlan", "productionBatch", "fleetAllocationStrategy", "fleetAllocationRun",
  "fleetAllocationResult", "robotaxiDeliveryOrder", "supplyDemandBalanceStrategy", "supplyDemandBalanceRun",
  "supplyDemandBalanceResult", "ownerSupply",
].forEach((value) => assert.notEqual(getDisplayValue(value), value, `供应经营对象缺少中文值：${value}`));
