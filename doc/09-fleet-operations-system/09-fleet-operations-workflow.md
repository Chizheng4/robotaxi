...
|任务完成|Robotaxi 后续状态|
|---|---|
|ReadinessCheckTask 通过|AVAILABLE / NONE|
|CleaningTask 完成|AVAILABLE / NONE，或配置进入 PENDING_INSPECTION|
|ChargingTask 完成|AVAILABLE / NONE，或配置进入 PENDING_INSPECTION|
|MaintenanceTask 完成|PENDING_INSPECTION / READY_FOR_INSPECTION|
|FailureHandlingTask 误报|恢复原状态|
|FailureHandlingTask 转维修|UNAVAILABLE / NEED_MAINTENANCE|
|FailureHandlingTask 转退役|RETIRED / RETIRED|
|RetirementTask 完成|RETIRED / RETIRED|
