...
|WAITING_DISPOSITION|等待处置决策|选择处置结果|
|TRANSFERRED_TO_MAINTENANCE|已转维修|关联 MaintenanceTask|
|TRANSFERRED_TO_RETIREMENT|已转退役|关联 RetirementTask|
|RESOLVED_NO_ACTION|误报或无需处理|恢复状态|
|COMPLETED|处理完成|无|
|CANCELLED|任务取消|无|
|FAILED|处理失败|人工处理|
...
|---|---|---|
|低风险故障且服务中|AVAILABLE|WAITING_SERVICE_COMPLETION|
|待诊断|UNAVAILABLE|BROKEN 或 NEED_MAINTENANCE|
|诊断中|UNAVAILABLE|BROKEN|
|误报|恢复原值|恢复原值|
|转维修|UNAVAILABLE|NEED_MAINTENANCE|
|转退役|RETIRED|RETIRED|
