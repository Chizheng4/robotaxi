...
5. **边界**
   - 本轮只做供给端画像底座。
   - 不提前实现长期需求预测、供应计划、供给单业务闭环。
   - 不接入模拟运行主路径，避免影响现有模拟效率和业务闭环。

6. **v041.1.1 配置保存整体重算补丁（已完成）**
