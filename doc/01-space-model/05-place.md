...
Place（地点 / 需求来源）表示 Map 中会产生出行需求的地点、建筑、土地使用区域或特殊运营设施。
...
|OPS_CENTER|运营中心|Robotaxi 供给侧运营设施，也可以产生员工通勤、访客等人员出行需求|
...
10. `OPS_CENTER` 是 Place 的特殊类型，既表达地图地点，也关联供给侧运营设施对象；

11. 不同 `place_type` 应在地图中使用不同颜色展示，帮助运营人员快速识别真实空间用途。
...
|SCHOOL|学校|浅黄色|
|HOSPITAL|医院|浅红色|
|METRO_STATION|地铁站|浅青色|
|HOTEL|酒店|浅粉色|
|TRANSPORT_HUB|交通枢纽|浅灰蓝色|
|OPS_CENTER|运营中心|浅紫色|
