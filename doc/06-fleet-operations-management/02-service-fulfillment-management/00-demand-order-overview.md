...
├── 01-customer.md
└── initialization-customer.md
```

服务履约管理模块：

```text
06-fleet-operations-management/02-service-fulfillment-management/
├── 00-demand-order-overview.md
├── 01-demand-simulation-strategy.md
├── 02-service-order.md
├── 03-pricing-decision.md
└── 04-order-matching-decision.md
```

车队资产行驶模块：

```text
05-fleet-asset-management/
├── 02-route-planning-strategy.md
├── 03-route.md
├── 04-route-execution.md
└── 05-trip.md
```
