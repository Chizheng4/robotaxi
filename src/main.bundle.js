...
function getDetailTabs(selectedType) {
  ...
  if (selectedType === "trip") {
    return [{
      ...
      key: "route",
      label: "路径关联",
      keys: ["route_id", "route_planning_run_id", "route_history"]
    }, {
      key: "time",
      label: "状态时间",
