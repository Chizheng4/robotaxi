export const objectDictionary = {
  ...
  pricingStrategyRun: { label: "定价执行记录", detailTitle: "定价执行详情" },
  pricingDecision: { label: "定价决策", detailTitle: "定价决策详情" },
  ...
  demandSimulationRun: { label: "需求模拟执行记录", detailTitle: "需求模拟执行详情" },
...
export const fieldDictionary = {
  ...
  pricing_strategy_run_id: "定价执行记录编号",
  ...
  demand_simulation_run_id: "需求模拟执行记录编号",
