...
export const normalWorkflowTransitions = [
  ...
  transition("CLEANING_DESTINATION_ASSIGN", "cleaningTask", "WAITING_DESTINATION_ASSIGNMENT", "FLEET_OPERATION_DESTINATION_ASSIGN", "WAITING_ROUTE", D, "cleaning-destination", F, 5),
  transition("CLEANING_ROUTE_PLAN", "cleaningTask", "WAITING_ROUTE", "FLEET_OPERATION_ROUTE_PLAN", "MOVING_TO_OPS_CENTER", D, "fleet-operation-route-plan", F, 8),
  transition("CLEANING_ROUTE_MOVE", "cleaningTask", "MOVING_TO_OPS_CENTER", "FLEET_OPERATION_ROUTE_PROGRESS", "ARRIVED_OPS_CENTER", D, "fleet-operation-route-move", C, 4),
  transition("CLEANING_ROUTE_ARRIVAL", "cleaningTask", "ARRIVED_OPS_CENTER", "FLEET_OPERATION_ROUTE_ARRIVAL_RESULT", "WAITING_WORKER_ASSIGNMENT", D, "fleet-operation-arrival", F, 3),
  transition("CLEANING_WORKER_ASSIGN", "cleaningTask", "WAITING_WORKER_ASSIGNMENT", "FLEET_OPERATION_WORKER_ASSIGN", "READY_TO_CLEAN", D, "cleaning-worker-assign", F, 30),
  transition("CLEANING_WORK_START", "cleaningTask", "READY_TO_CLEAN", "FLEET_OPERATION_WORK_START", "CLEANING", D, "cleaning-work-start", F, 30),
  transition("CLEANING_WORK_COMPLETE", "cleaningTask", "CLEANING", "FLEET_OPERATION_WORK_COMPLETE", "COMPLETED", D, "cleaning-work-complete", F, 600),

  transition("CHARGING_DESTINATION_ASSIGN", "chargingTask", "WAITING_CHARGING_DESTINATION_ASSIGNMENT", "FLEET_OPERATION_DESTINATION_ASSIGN", "WAITING_ROUTE", D, "charging-destination", F, 5),
  transition("CHARGING_ROUTE_PLAN", "chargingTask", "WAITING_ROUTE", "FLEET_OPERATION_ROUTE_PLAN", "MOVING_TO_CHARGER", D, "fleet-operation-route-plan", F, 8),
  transition("CHARGING_ROUTE_MOVE", "chargingTask", "MOVING_TO_CHARGER", "FLEET_OPERATION_ROUTE_PROGRESS", "ARRIVED_CHARGER", D, "fleet-operation-route-move", C, 4),
  transition("CHARGING_ROUTE_ARRIVAL", "chargingTask", "ARRIVED_CHARGER", "FLEET_OPERATION_ROUTE_ARRIVAL_RESULT", "WAITING_CHARGER_ASSIGNMENT", D, "fleet-operation-arrival", F, 3),
  ...
  transition("MAINTENANCE_DESTINATION_ASSIGN", "maintenanceTask", "WAITING_MAINTENANCE_DESTINATION_ASSIGNMENT", "FLEET_OPERATION_DESTINATION_ASSIGN", "WAITING_ROUTE", D, "maintenance-destination", F, 5),
  transition("MAINTENANCE_ROUTE_PLAN", "maintenanceTask", "WAITING_ROUTE", "FLEET_OPERATION_ROUTE_PLAN", "MOVING_TO_MAINTENANCE_CENTER", D, "fleet-operation-route-plan", F, 8),
  transition("MAINTENANCE_ROUTE_MOVE", "maintenanceTask", "MOVING_TO_MAINTENANCE_CENTER", "FLEET_OPERATION_ROUTE_PROGRESS", "ARRIVED_MAINTENANCE_CENTER", D, "fleet-operation-route-move", C, 4),
  transition("MAINTENANCE_ROUTE_ARRIVAL", "maintenanceTask", "ARRIVED_MAINTENANCE_CENTER", "FLEET_OPERATION_ROUTE_ARRIVAL_RESULT", "WAITING_RESOURCE_ASSIGNMENT", D, "fleet-operation-arrival", F, 3),
  transition("MAINTENANCE_WORKER_ASSIGN", "maintenanceTask", "WAITING_RESOURCE_ASSIGNMENT", "FLEET_OPERATION_WORKER_ASSIGN", "READY_TO_REPAIR", D, "maintenance-worker-assign", F, 60),
  transition("MAINTENANCE_WORK_START", "maintenanceTask", "READY_TO_REPAIR", "FLEET_OPERATION_WORK_START", "REPAIRING", D, "maintenance-work-start", F, 60),
  transition("MAINTENANCE_WORK_COMPLETE", "maintenanceTask", "REPAIRING", "FLEET_OPERATION_WORK_COMPLETE", "COMPLETED", D, "maintenance-work-complete", F, 900),
  ...
  transition("RETIREMENT_ROUTE_PLAN", "retirementTask", "WAITING_ROUTE", "FLEET_OPERATION_ROUTE_PLAN", "MOVING_TO_RETIREMENT_CENTER", D, "fleet-operation-route-plan", F, 8),
  transition("RETIREMENT_ROUTE_MOVE", "retirementTask", "MOVING_TO_RETIREMENT_CENTER", "FLEET_OPERATION_ROUTE_PROGRESS", "ARRIVED_RETIREMENT_CENTER", D, "fleet-operation-route-move", C, 4),
  transition("RETIREMENT_ROUTE_ARRIVAL", "retirementTask", "ARRIVED_RETIREMENT_CENTER", "FLEET_OPERATION_ROUTE_ARRIVAL_RESULT", "PROCESSING_RETIREMENT", D, "fleet-operation-arrival", F, 3),
