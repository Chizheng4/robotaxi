...
export const normalWorkflowTransitions = [
  ...
  projection("CLEANING_ROUTE_PLAN", "cleaningTask", "WAITING_ROUTE", "ROUTE_PLAN", "MOVING_TO_OPS_CENTER", "fleet-operation-route-plan", F, 8, "routeExecution", "WAITING_ROUTE", "ROUTE_PLAN"),
  projection("CLEANING_ROUTE_MOVE", "cleaningTask", "MOVING_TO_OPS_CENTER", "ROUTE_EXECUTION_STEP", "ARRIVED_OPS_CENTER", "fleet-operation-route-move", C, 4, "routeExecution", "MOVING", "ROUTE_MOVE"),
  projection("CLEANING_ROUTE_ARRIVAL", "cleaningTask", "ARRIVED_OPS_CENTER", "ARRIVAL_CONFIRM", "WAITING_WORKER_ASSIGNMENT", "fleet-operation-arrival", F, 3, "routeExecution", "ARRIVED", "ROUTE_ARRIVAL"),
  ...
  projection("CHARGING_ROUTE_PLAN", "chargingTask", "WAITING_ROUTE", "ROUTE_PLAN", "MOVING_TO_CHARGER", "fleet-operation-route-plan", F, 8, "routeExecution", "WAITING_ROUTE", "ROUTE_PLAN"),
  projection("CHARGING_ROUTE_MOVE", "chargingTask", "MOVING_TO_CHARGER", "ROUTE_EXECUTION_STEP", "ARRIVED_CHARGER", "fleet-operation-route-move", C, 4, "routeExecution", "MOVING", "ROUTE_MOVE"),
  projection("CHARGING_ROUTE_ARRIVAL", "chargingTask", "ARRIVED_CHARGER", "ARRIVAL_CONFIRM", "WAITING_CHARGER_ASSIGNMENT", "fleet-operation-arrival", F, 3, "routeExecution", "ARRIVED", "ROUTE_ARRIVAL"),
  ...
  projection("MAINTENANCE_ROUTE_PLAN", "maintenanceTask", "WAITING_ROUTE", "ROUTE_PLAN", "MOVING_TO_MAINTENANCE_CENTER", "fleet-operation-route-plan", F, 8, "routeExecution", "WAITING_ROUTE", "ROUTE_PLAN"),
  projection("MAINTENANCE_ROUTE_MOVE", "maintenanceTask", "MOVING_TO_MAINTENANCE_CENTER", "ROUTE_EXECUTION_STEP", "ARRIVED_MAINTENANCE_CENTER", "fleet-operation-route-move", C, 4, "routeExecution", "MOVING", "ROUTE_MOVE"),
  projection("MAINTENANCE_ROUTE_ARRIVAL", "maintenanceTask", "ARRIVED_MAINTENANCE_CENTER", "ARRIVAL_CONFIRM", "WAITING_RESOURCE_ASSIGNMENT", "fleet-operation-arrival", F, 3, "routeExecution", "ARRIVED", "ROUTE_ARRIVAL"),
  ...
  projection("RETIREMENT_ROUTE_ARRIVAL", "retirementTask", "ARRIVED_RETIREMENT_CENTER", "ARRIVAL_CONFIRM", "PROCESSING_RETIREMENT", "fleet-operation-arrival", F, 3, "routeExecution", "ARRIVED", "ROUTE_ARRIVAL"),
