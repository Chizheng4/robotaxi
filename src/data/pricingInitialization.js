  ...
  return {
    pricingStrategies: [
      ...
      createPricingStrategy({
        ...
        base_fare: null,
        distance_unit_price: null,
        time_unit_price: null,
        supply_demand_multiplier: null,
        time_period_multiplier: null,
        service_area_multiplier: null,
        channel_multiplier: null,
        strategy_status: PricingStrategyStatus.ACTIVE,
