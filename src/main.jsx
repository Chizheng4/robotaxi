    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { key: "orderMatchingRuns", label: "匹配执行管理" },
          { key: "orderMatchingDecisions", label: "匹配决策管理" },
        ],
      },
    ],
  },
    ...
    <section className={isReadinessPage ? "record-page-new readiness-page" : "record-page-new"}>
      ...
      {hasEventPanel && (
        <div className="event-log-section" style={{ height: eventPanelHeight }}>
          ...
          <div className="event-log-title">{isDemandSimulationPage ? "需求模拟执行记录" : isRoutePlanningPage ? "路径规划执行记录" : isPricingPage ? "定价执行记录" : isOrderMatchingPage ? "匹配执行记录" : "最近任务事件"}</div>
          <Table
            size="small"
            rowKey={eventRowKey}
...
async function bootstrap() {
  const [
    ...
    import("./data/tripValidation.js?v=20260611-v019-7-service-route"),
    ...
    import("./domain/tripTypes.js?v=20260611-v019-7-service-route"),
    import("./data/cellContext.js?v=20260608-v018-bfs-route-planning"),
    import("./domain/fieldDictionary.js?v=20260611-v019-7-service-route"),
    ...
    import("./domain/taskTypes.js?v=20260611-v019-7-service-route"),
  ]);
