...
平台以业务单据生命周期作为经营事实底座，以统一经营模型连接规划、执行与反馈。经营模型按需求、供给、服务、资产、财务和经营反馈组织，不替代业务单据，也不在页面中复制计算逻辑。
...
经营规划回答未来需要什么，业务执行形成真实单据和资产事实，经营分析回答实际结果与目标及预测存在什么差异。三者通过统一字段字典、指标语义合同和经营数据池连接。
